...
func latestSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "latest.sql", size: 19898, mode: os.FileMode(420), modTime: time.Unix(1523419121, 0)}
